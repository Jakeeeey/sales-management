...
import ProspectingActivationReportModule from "@/modules/business-intelligence-analytics/prospecting-activation-report";
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-3 sm:p-4 space-y-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Compare approved customer prospects with active customer entries to track activation status.
          </p>
        </div>

        <ProspectingActivationReportModule />
      </main>
    </div>
  );
}
