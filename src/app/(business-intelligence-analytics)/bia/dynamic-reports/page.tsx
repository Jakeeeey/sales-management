...
import { DynamicReportsModule } from "@/modules/business-intelligence-analytics/dynamic-reports";
...
export default async function Page() {
  ...
  return (
    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-hidden p-2 sm:p-4">
