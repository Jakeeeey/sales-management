...
async function proxy(req: NextRequest) {
    ...
    // We'll fetch all active TRADE suppliers
    url.searchParams.set("filter[isActive][_eq]", "1");
    url.searchParams.set("filter[supplier_type][_contains]", "TRADE");
    url.searchParams.set("sort", "supplier_name");
    url.searchParams.set("fields", "id,supplier_name,supplier_type");
