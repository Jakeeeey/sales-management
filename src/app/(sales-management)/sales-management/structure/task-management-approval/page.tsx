// src/app/(customer-relationship-management)/crm/structure/task-management-approval/page.tsx
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
import TaskManagementApprovalModule from "@/modules/sales-management/structure/task-management-approval/TaskManagementApprovalModule";
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbPage>Task Management Approval</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
