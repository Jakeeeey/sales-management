...
export const fetchExecutiveHealthData = async (startDate: string, endDate: string) => {
    ...
    const url = `/api/bia/crm/target-setting-reports/divisional-channel/executive-health-channel?startDate=${startDate}&endDate=${endDate}&_t=${timestamp}`;
...
export const fetchCompanyTargets = async (startDate: string, endDate: string): Promise<TargetSettingExecutive[]> => {
    ...
    const url = `/api/bia/crm/target-setting/divisional-channel/executive?filter=${filter}&sort=fiscal_period`;
...
export const fetchDivisionTargets = async (tseIds: number[]): Promise<TargetSettingDivision[]> => {
    ...
    const url = `/api/bia/crm/target-setting/divisional-channel/executive?scope=division&filter=${filter}`;
