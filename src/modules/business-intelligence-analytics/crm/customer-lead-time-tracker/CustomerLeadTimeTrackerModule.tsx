...
import { useLeadTimeReport } from "./hooks/useCustomerLeadTimeReport";

export default function CustomerLeadTimeTrackerModule() {
  ...
  return (
    <div className="space-y-6  mx-auto">
      <Filters
        ...
        loadingCustomers={hook.loadingCustomers}
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold tracking-tight">Lead Time Analytics</h2>
        <AIAnalystReport rows={hook.rows} loading={hook.loadingData} />
      </div>
