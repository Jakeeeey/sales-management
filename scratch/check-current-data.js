...
async function checkSalesReportDates() {
  try {
    const url = `${BASE_URL}/api/view-sales-report-itemized/filtered?startDate=2025-01-01&endDate=2025-12-31`;
    ...
    console.log('Unique Year-Months in Sales Report for 2025:');
